...
INSERT INTO EMP_01 -- 여러 개 행 넣을 땐 VALUSE 쓰지 않기!!!!!!!!!!!!!!!
(
    SELECT E.EMP_ID, EMP_NAME, DEPT_TITLE
    FROM EMPLOYEE E
...
FROM employee
WHERE 1=2 -- 실행결과가 무조건 안 맞게 만들어 놓기 = 행을 안 가져오기 위해
;
...
SELECT * FROM EMP_MANAGER; -- 회원정보를 결제 정보 테이블 둘 다에 넣어주어야 하는 경우 INSERT ALL 이용해서 처리 가능.
