...
public class MemberController {
	 ...
	 * 회원가입
	 * 
	 * 1. 데이터 입력받기(아이디 닉네임...) -> controller - 입력받은 아이디 유효성 검사 -> service - 비밀번호 유효성
	 * 검사 -> service - 아이디 중복 검사 -> service
	 * 
	 * 2. db에 insert -> dao 
	 * 
	 * 3. insert 결과에 따라 다음 작업 진행 -> controller
	 * 
	 */
	public void join() {
