...
public class MenuDao {
	...
	public int insertRecipe(Connection conn, MenuVo menuVo) {
		...
		String sql = "INSERT INTO MENU( NO ,MENU_CATE_NO ,MENU_NAME ,MENU_INFO ,RECIPE ,CAL ,MENU_PROD ,IMG_PATH) VALUES (SEQ_MENU_NO.NEXTVAL, ? , ?, ?, ?, ? ,?, IMG)";
		PreparedStatement pstmt = null;
		int result = 0;
		...
		try {
			...
			pstmt.setString(5, menuVo.getCal());
			pstmt.setString(6, menuVo.getMenuProd());
