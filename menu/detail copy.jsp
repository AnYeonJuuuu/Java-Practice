...
<link rel="stylesheet" href="/cookTeacher/resources/css/menu/detail copy.css">
                ...
                <div id="en">
                    ...
                    <div style="margin-top: 0;">
                        <div style="font-size: 2rem; margin-bottom: 10px; text-align: center;">
                            ...
                            <img id="b-like" src="/cookTeacher/resources/img/좋아요(검).jpg" alt="식재료게시판담당" width="40px" height="40px">
                        </div>
